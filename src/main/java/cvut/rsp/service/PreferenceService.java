...
import cvut.rsp.api.repository.IPreferenceRepository;
...
public class PreferenceService implements IPreferenceService
{
    ...
    @Transactional
    @Override public Preference create(List<Producer> producers, List<Actor> actors, List<Director> directors, Set<MusicalType> musicalTypes, Set<MusicalGenre> musicalGenres, Set<MusicalAtmosphere> musicalAtmospheres)
    {
        return null;
    }

    @Transactional
    @Override public Preference find(Long id) { return iRepository.findById(id).get(); }

    @Transactional
    @Override public Preference update(Long id)
    {
    ...
    @Transactional
    @Override public void delete(Long id) { iRepository.delete(find(id)); }
}
